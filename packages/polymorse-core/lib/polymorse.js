...
const PolyMorseConfig = require(`./polymorse-config`);
...
class PolyMorse {
    ...
    static Init() {
        ...
        this.CONFIG = new PolyMorseConfig(`polymorse.config.json`);
        ...
        let
            projectPackageJson = PolyMorse.projectConfig.__packagejson,
        ...
        this.projectVersion = ((PolyMorse.projectConfig.__packagejson ? PolyMorse.projectConfig.__packagejson.version : false) || `0.0.0`);
